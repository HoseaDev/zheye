...
import {BaseResult, ImageProps, PostProps, UserProps} from "@/model/ModelDeclare";
...
onMounted(() => {
  store.dispatch('getPostById', currentId)
})
...
const hideAndDelete = () => {
  ...
  store.dispatch('deletePost', currentId).then((rawData: BaseResult<PostProps>) => {
